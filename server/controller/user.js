...
exports.requestPasswordReset = async (req, res) => {
  ...
  User.findOne({ email }, (err, user) => {
    ...
    const link = `localhost:${process.env.PORT}/resetPasswordPage/${resetToken}`;
    sendMail(email, link);
...
const sendMail = (email, link) => {
  ...
  <div style="background-color: rgb(60, 60, 60); margin: -1rem; height: fit-content; color:white!important">
    <div style=" margin: 0 10vw !important;   background-color: #1e1e1e;   min-height: 50vh;   color: white !important; padding: 10%">
